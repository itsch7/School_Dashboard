...
export const menuItems = [
    {
      ...
      items: [
        {
          icon: "../assets/public/home.png",
          label: "Home",
          href: "/",
          visible: ["admin", "teacher", "student", "parent"],
        },
        {
          icon: "../assets/public/teacher.png",
          label: "Teachers",
          href: "/list/teachers",
          visible: ["admin", "teacher"],
        },
        {
          icon: "../assets/public/student.png",
          label: "Students",
          href: "/list/students",
          visible: ["admin", "teacher"],
        },
        {
          icon: "../assets/public/parent.png",
          label: "Parents",
          href: "/list/parents",
          visible: ["admin", "teacher"],
        },
        {
          icon: "../assets/public/subject.png",
          label: "Subjects",
          href: "/list/subjects",
          visible: ["admin"],
        },
        {
          icon: "../assets/public/class.png",
          label: "Classes",
          href: "/list/classes",
          visible: ["admin", "teacher"],
        },
        {
          icon: "../assets/public/lesson.png",
          label: "Lessons",
          href: "/list/lessons",
          visible: ["admin", "teacher"],
        },
        {
          icon: "../assets/public/exam.png",
          label: "Exams",
          href: "/list/exams",
          visible: ["admin", "teacher", "student", "parent"],
        },
        {
          icon: "../assets/public/assignment.png",
          label: "Assignments",
          href: "/list/assignments",
          visible: ["admin", "teacher", "student", "parent"],
        },
        {
          icon: "../assets/public/result.png",
          label: "Results",
          href: "/list/results",
          visible: ["admin", "teacher", "student", "parent"],
        },
        // {
        //   icon: "../assets/public/attendance.png",
        //   label: "Attendance",
        //   href: "/list/attendance",
        //   visible: ["admin", "teacher", "student", "parent"],
        // },
        {
          icon: "../assets/public/calendar.png",
          label: "Events",
          href: "/list/events",
          visible: ["admin", "teacher", "student", "parent"],
        },
        // {
        //   icon: "../assets/public/message.png",
        //   label: "Messages",
        //   href: "/list/messages",
        //   visible: ["admin", "teacher", "student", "parent"],
        // },
        {
          icon: "../assets/public/announcement.png",
          label: "Announcements",
    ...
    },
    {
      ...
      items: [
        {
          icon: "../assets/public/profile.png",
          label: "Profile",
          href: "/profile",
          visible: ["admin", "teacher", "student", "parent"],
        },
        {
          icon: "../assets/public/setting.png",
          label: "Settings",
          href: "/settings",
          visible: ["admin", "teacher", "student", "parent"],
        },
        {
          icon: "../assets/public/logout.png",
          label: "Logout",
          href: "/logout",
          visible: ["admin", "teacher", "student", "parent"],
        },
  ...
  export const events: Event[] = [
    ...
    },
    {
      ...
      date: '2024-09-26',
      description: 'Celebrate John\'s birthday at the park.',
      time:'12:00 PM - 2:00 PM'
